...
export function Header({ view, onMenuClick, user, notifications, setNotifications }) {
  ...
  const titles = {
    ...
    challenges: "Challenges & Leaderboard", shifts: "Staff Shifts",
...
const BOTTOM_CATS = {
  admin: [
    ...
    { id: "more",    icon: Layers,       label: "More",    items: ["chat","challenges","profile"] },
  ],
  receptionist: [
  ...
  trainer: [
    ...
    { id: "more",     icon: Layers,        label: "More",     items: ["profile"] },
  ],
  member: [
    { id: "train",   icon: Dumbbell,    label: "Train",   items: ["my-workouts","book-classes","my-history"] },
    { id: "social",  icon: Users,       label: "Social",  items: ["friends","chat","challenges","my-rewards","my-referrals"] },
